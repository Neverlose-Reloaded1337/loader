...
{
	DWORD exception_addr = (DWORD)ExceptionInfo->ExceptionRecord->ExceptionAddress;

	if (!g_neverlose.in_range(ExceptionInfo->ExceptionRecord->ExceptionAddress))
	{
		if ((exception_addr & 0xF0000000) == 0x70000000)
